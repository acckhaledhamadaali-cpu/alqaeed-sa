      ...
      "@graph": [
        {
          ...
          "knowsAbout": [
            "محاسبة المطاعم والمقاهي",
            "محاسبة التجزئة والمتاجر",
            "محاسبة المقاولات وتكاليف المشاريع",
            "محاسبة الشركات الخدمية",
            "تنظيم وتجهيز المناسبات والفعاليات",
            "محاسبة التجارة والتوزيع",
            "الإدارة المالية للشركات الناشئة"
          ]
        },
        {
          "@type": "WebSite",
