...
const STATISTICS: StatItem[] = [
  ...
  { value: "AI FINANCIAL", label: "هندسة الاوامر المالية" }
];

const OPENING_PARAGRAPH = "لأنهم لا يبحثون عن محاسب يسجل العمليات فقط بل عن شخص يساعدهم على فهم أرقام منشآتهم واتخاذ قرارات مالية أفضل:";

const BULLETS = [
  "لا أكتفي بإعداد الحسابات بل أبني نظاماً مالياً يساعدك على إدارة منشأتك.",
  "أحول الأرقام إلى تقارير تساعدك على فهم أداء منشأتك واتخاذ القرار.",
  "أجمع بين **Financial Accounting** و **Financial Analysis** و **Management Reporting** و **Virtual CFO**.",
  "أكثر من **9 سنوات** من الخبرة مع ماجستير إدارة الأعمال **MBA** وخبرة في قطاعات متعددة داخل المملكة العربية السعودية."
];

const QUOTE: string = "الاستقرار المالي لمنشأتك يبدأ عندما تتحول البيانات إلى قرارات إدارية مبنية على تقارير مالية واضحة.";
