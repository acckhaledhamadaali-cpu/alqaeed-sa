...
const CHALLENGES: ChallengeItem[] = [
  {
    ...
    solution: "إعداد القوائم المالية والتقارير الدورية التي توضح نتائج الأعمال والأرباح الفعلية بدقة وشفافية."
  },
  {
    problem: "عدم تنظيم الحسابات والبيانات المالية والامتثال",
    solution: "تنظيم القيود المحاسبية ومسك الدفاتر وتجهيز متطلبات الزكاة والضريبة والامتثال دون تعقيد."
  },
  {
    problem: "غياب التقارير المالية والإدارية المفيدة لاتخاذ القرار",
    solution: "إصدار تقارير مالية وتحليلات إدارية دورية تساعد الإدارة على قراءة الأرقام واتخاذ القرارات باطمئنان."
  },
  {
    problem: "ضعف وضوح التدفقات النقدية وحركة السيولة",
    solution: "متابعة المقبوضات والمدفوعات وتخطيط السيولة لتأمين الالتزامات التشغيلية وتفادي أي عجز مفاجئ."
  },
  {
    problem: "الحاجة إلى خبرة مالية متقدمة أو مدير مالي (Virtual CFO) دون تكلفة توظيف كاملة",
    solution: "تقديم خدمات الإدارة المالية والاستشارات عن بعد بمرونة عالية للاستفادة من الخبرة الاستراتيجية بتكلفة اقتصادية."
  }
];
