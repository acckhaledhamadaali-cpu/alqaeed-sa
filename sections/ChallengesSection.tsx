...
const CHALLENGES: ChallengeItem[] = [
  ...
  {
    problem: "التدفقات النقدية غير واضحة والتزامات التشغيل مقلقة",
    solution: "أتابع حركة المقبوضات والمدفوعات وأعد توقعات السيولة لضمان الوفاء بالالتزامات في مواعيدها وتفادي أي فجوات نقدية مفاجئة."
  },
  {
    problem: "تحتاج إلى خبرة مالية متقدمة دون تكلفة إدارة مالية داخلية كاملة",
    solution: "أتولى تنظيم الحسابات وإعداد القوائم والتقارير المالية التحليلية بما يمنحك وضوحاً شاملاً بتكلفة مرنة واقتصادية."
  },
  {
    problem: "أحتاج إلى مدير مالي استراتيجي لكن تكلفة التوظيف المباشر مرتفعة",
    solution: "أتولى دور المدير المالي عن بعد (Virtual CFO) لتستفيد من الخبرة الإدارية والمالية العميقة دون تحمل أعباء التوظيف الثابتة."
  },
  {
    problem: "الزكاة والضرائب تستغرق وقتاً وتثير القلق من الأخطاء",
    solution: "أتولى تدقيق البيانات المحاسبية وإعداد الإقرارات الزكوية والضريبية بدقة وفق متطلبات هيئة الزكاة والضريبة والجمارك (ZATCA) للحد من مخاطر الأخطاء والمخالفات."
  }
];
