  ...
  return (
    <SectionWrapper id="footer-section-wrapper" variant="white" spacing="none" as="footer" {...props}>
      <Container id="footer-container">
        <div id="footer-content" className="py-8 md:py-12 flex flex-col items-center justify-center text-center space-y-2 border-t border-white">
          ...
          <div id="footer-contact" className={`text-xs font-medium tracking-wider font-arabic uppercase text-text-secondary font-arabic mt-2 flex flex-wrap gap-x-4 gap-y-1 justify-center items-center`}>
