...
const STEPS: Step[] = [
  {
    number: "1",
    title: "تقييم الوضع المالي الحالي",
    description: "جلسة تواصل أولية وسريعة لفهم طبيعة نشاطك، وتحديد التحديات المالية الأكثر إلحاحاً لمنشأتك."
  },
  {
    number: "2",
    title: "مراجعة الحسابات والنظام المحاسبي",
    description: "فحص العمليات السابقة والبرنامج المحاسبي المستخدم للتحقق من سلامة الأرصدة وتوافقها النظامي."
  },
  {
    number: "3",
    title: "تنظيم الدورة المحاسبية",
    description: "ترتيب تدفق الفواتير، تسجيل القيود بانتظام، وإجراء المطابقات البنكية لبناء قاعدة بيانات دقيقة."
  },
  {
    number: "4",
    title: "إعداد التقارير المالية",
    description: "استخراج ميزان المراجعة، قائمة الدخل، والمركز المالي بوضوح واحترافية وبدون أي تعقيد."
  },
  {
    number: "5",
    title: "التحليل المالي",
    description: "قراءة الأرقام بعمق لتحديد هوامش الربحية، مصادر التكاليف، وحركة التدفقات النقدية الفعلية."
  },
  {
    number: "6",
    title: "مناقشة النتائج والتوصيات",
    description: "جلسة دورية نوضح لك فيها حقيقة الأداء، ونقدم حلولاً وتوصيات مالية عملية تدعم قراراتك."
  },
  {
    number: "7",
    title: "المتابعة الدورية",
    description: "مرافقة مستمرة شهرياً لمراقبة استقرار السيولة، وحماية المنشأة، ودعم خطط نموها المستدام."
  }
];
