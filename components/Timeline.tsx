...
const STEPS: Step[] = [
  {
    number: "1",
    title: "أفهم منشأتك",
    description: "أدرس طبيعة عملك ونشاطك الحالي، وأحدد نقاط الضعف والمشاكل التي تحتاج إلى معالجة فورية."
  },
  {
    number: "2",
    title: "أبني النظام المالي",
    description: "أؤسس هيكلاً مالياً متيناً يسجل الإيرادات والمصروفات والتدفقات النقدية بدقة."
  },
  {
    number: "3",
    title: "أتابع الأداء وأقدم التوصيات",
    description: "أتابع أداء حساباتك بشكل دوري، وأقدم لك تقارير واضحة وتوصيات عملية تساعدك على تنمية منشأتك وتجنب أي خسائر."
  }
];
