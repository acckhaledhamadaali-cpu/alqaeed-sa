...
const STEPS: Step[] = [
  {
    number: "1",
    title: "أفهم منشأتك",
    description: "أدرس طبيعة نشاطك وواقع حساباتك الحالي، لتحديد الأولويات ونقاط التطوير المالي المطلوبة."
  },
  {
    number: "2",
    title: "أبني النظام المالي",
    description: "أؤسس هيكلاً محاسبياً متيناً يسجل العمليات بدقة وينظم حركة الإيرادات والمصروفات والسيولة."
  },
  {
    number: "3",
    title: "أتابع الأداء وأقدم التوصيات",
    description: "أتابع الحسابات دورياً وأصدر تقارير إدارية واضحة وتوصيات عملية تدعم اتخاذ قرارات مالية أفضل."
  }
];
